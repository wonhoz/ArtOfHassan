...
namespace ArtOfWarFarming
{
    ...
    public partial class MainWindow : Window
    {
        ...
        //private static System.Timers.Timer MouseTrackingTimer;
        private static System.Timers.Timer WorkingFlowTimer = new System.Timers.Timer();
        ...
        public MainWindow()
        {
            ...
            //MouseTrackingTimer = new System.Timers.Timer(100);
            //MouseTrackingTimer.Elapsed += MouseTrackingTimerFunction;
            //MouseTrackingTimer.Enabled = true;

            WorkingFlowTimer.Interval = 1000; // 1초
            WorkingFlowTimer.Elapsed += WorkingTimerFunction;
        }

        private void Window_Closing(object sender, System.ComponentModel.CancelEventArgs e)
        {
            //MouseTrackingTimer.Enabled = false;
            WorkingFlowTimer.Enabled = false;
        }

        private void MouseTrackingTimerFunction(object sender, System.Timers.ElapsedEventArgs e)
        {
            System.Windows.Application.Current.Dispatcher.Invoke(DispatcherPriority.Normal, new Action(delegate
            {
                //CurrentMousePosition.Text = System.Windows.Forms.Cursor.Position.X.ToString() + ", " +
        ...
        private void StartButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            //System.Windows.Forms.Cursor.Position = new System.Drawing.Point(598, 338);
            //mouse_event(LBUTTONDOWN, 0, 0, 0, 0);
            //mouse_event(LBUTTONUP, 0, 0, 0, 0);
        }

        private void WorkingTimerFunction(object sender, System.Timers.ElapsedEventArgs e)
        {
